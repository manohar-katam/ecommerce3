  ...
  <div class="row">
    <div class="col-sm-6 col-xs-12 personal-info">
      ...
      <div class="form-group pull-right">
         <a href="../checkout.php" class="btn btn-default">Cancel</a>
  ...
  ?>
      ...
      <div class="container">
       <div class="col-xs-6 col-md-offset-3">
        <div class="row">
       <a href="ship_details.php?add=1" class="btn btn-success" id="add-product-btn "> Add Shipping Address</a><div class="clearfix">
      <table class="table table-bordered table-condensed table-striped">
        <thead><th>SHIPPING ADDRESS</th></thead>
        <tbody>
          <?php while($cusdetails=mysqli_fetch_assoc($results)): ?>
            <tr>
            <td><span class="pull-right"> <a href="ship_details.php?edit=<?=$cusdetails['cus_detail_id'];?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-pencil"></span></a>   <a href="ship_details.php?delete=<?=$cusdetails['cus_detail_id'];?>" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a></span>
