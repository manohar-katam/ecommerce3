...
<div class="container" style="margin-top: 125px">
  <div class="row">
    <div class="col-md-12">
      <h2 class="text-center"> Your Cart </h2><hr>
      <?php if($cart == ''): ?>
        <div class="bg-danger">
      ...
      <?php else: ?>
        ...
        <table class="table table-bordered table-condensed text-center">
          <thead class="totals-table-header" ><th class="text-center bg-primary"> Total Items</th><th class="text-center bg-primary">Grand Total before State Tax</th></thead>
          <tbody>
          <tr>
         ...
         <a href="../profile.php"> <button type="button" class="btn btn-warning"><< CONTINUE SHOPPING</button></a> 

         <a href="checkout.php"> <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-shopping-cart"></span> PROCEED TO CHECKOUT >></button></a>
         </div>
      <?php endif; ?>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function update_cart(mode,edit_id,edit_size){
    ...
    jQuery.ajax({
      url     : "/ecommerce3/cart/update_cart.php",
      method  : "post",
      data    : data,
      success : function(){
        location.reload();
