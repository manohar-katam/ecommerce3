  ...
  <form role="form" action="" method="post">
    <div class="row setup-content" id="step-1">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            <?php include 'parsers/delivery_address.php'; ?>
          </div>
    ...
    <div class="row setup-content" id="step-2">
        ...
        <div class="col-md-12">
          ...
          <?php include 'parsers/cart_review.php'; ?>
    ...
    <div class="row setup-content" id="step-3">
        ...
        <div class="col-md-12">
          <h3 class="text-center">Payment Details and Billing Address</h3>
           <?php include 'parsers/pay_bill_address.php'; ?>
          <a href="thankyou.php"><button class="btn btn-success btn-lg pull-right" type="submit">PLACE YOUR ORDER</button></a>
          </form>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  function update_tax(tax_id){
    ...
    jQuery.ajax({
      url     : "/ecommerce3/cart/parsers/cart_review.php",
      method  : "post",
      data    : data,
      success : function(){
        //location.reload("/ecommerce3/cart/parsers/cart_review.php");
        //$("#step-2").load("/ecommerce3/cart/checkout.php");
      },
      error   : function(){
