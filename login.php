...
<body>
 <h2 style="margin:0px; text-align: center;"><span class="largenav">Log In into your E-CART Account</span></h2><br><br>
     <div class="container">
     <div class="row" id="signinMsg">
				...
				<!-- login form starts here -->
					<form method="POST" action="#" role="form">
						...
						<div class="form-group" style="padding-top: 12px;">
							<button id="signinSubmit" name="signinSubmit" type="submit" class="btn btn-success btn-block">Sign in</button>
						</div>
						<div class="form-group divider">
							<hr class="left"><small>New to e-cart?</small><hr class="right">
						</div>
